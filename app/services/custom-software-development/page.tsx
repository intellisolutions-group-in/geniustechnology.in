        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4 animate-[fadeUp_0.8s_ease-out_0.2s_forwards] opacity-0">
              <StatCard label="100% Custom" desc="No Templates Used" />
              <StatCard label="Enterprise" desc="Grade Security" />
              <StatCard label="Modular" desc="Clean Architecture" />
              <StatCard label="Reliable" desc="Predictable Delivery" />
            </div>
          </div>
        </div>
      </section>
